...
@@application/shared_components/navigation/lists/mail_navegation.sql
@@application/shared_components/files/app_icon_svg.sql
@@application/shared_components/files/app_icon_css.sql
@@application/shared_components/files/mundschutz01_jpg.sql
@@application/shared_components/files/mundschutz03_jpg.sql
@@application/shared_components/files/mundschutz02_jpg.sql
@@application/shared_components/files/unsa_png.sql
@@application/shared_components/files/117181717_222841829020880_4548002104700932326_n_png.sql
@@application/plugin_settings.sql
@@application/shared_components/security/authorizations/administration_rights.sql
@@application/shared_components/security/authorizations/corona_admin.sql
...
@@application/shared_components/user_interface/lovs/lov_cor_categories.sql
...
@@application/shared_components/user_interface/templates/list/card_grande.sql
...
@@application/shared_components/security/authentications/corona_authentification.sql
@@application/shared_components/plugins/dynamic_action/nl_detora_apex_storelocation.sql
@@application/shared_components/plugins/region_type/com_eportela_webview.sql
@@application/shared_components/plugins/region_type/apex_oracle_osm_maps.sql
@@application/shared_components/plugins/dynamic_action/at_rammelhof_modernbackground.sql
@@application/shared_components/plugins/item_type/com_insum_placecomplete.sql
...
@@application/deployment/install/install_crear_objetos.sql
@@application/deployment/install/install_crear_datos.sql
