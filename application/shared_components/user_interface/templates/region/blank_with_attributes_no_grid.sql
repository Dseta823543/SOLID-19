...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(26668697791220914519)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(26679285010900417887)
,p_plug_template_id=>wwv_flow_api.id(26668697791220914519)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(26679285510564417887)
,p_plug_template_id=>wwv_flow_api.id(26668697791220914519)
,p_name=>'Sub Regions'
